...
if ($this->session->userdata('logged_in')) {
    ...
    $resultadoMural = $this->model_mural->buscarEnviados();
    ...
    if (( isset($resultadoMural) ) && (!empty($resultadoMural) )) {
        ...
        ?> 
        <div class="col-md-4 ">
            <div class = "alert alert-danger" role = "alert" style = "width: 350px; margin: 20 auto; padding-top: 10px;">
                Vocë náo tem nenhum Recado que foi enviado ativo no Mural...
            </div>        
        </div>
        <?php
    }
}  //  Fim if Session Login
?>
