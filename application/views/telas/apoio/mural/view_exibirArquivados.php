...
if ($this->session->userdata('logged_in')) {
    ...
    $dados['opcaoView'] = 'Mural - Arqquivados';
    $dados ['telaativa'] = 'Apoio';
    $dados['opcaoMenu'] = 'Mural';
    $this->load->model('model_mural');
    $resultadoMural = $this->model_mural->buscarArquivados();
    ...
    if (( isset($resultadoMural) ) && (!empty($resultadoMural) )) {
                        ...
                        <div class="box-footer <?php echo $corFooter; ?>" style="height: auto" >
                            ...
                            <div class="myDescription-block">                                                
                                <?php if ($mural->status == '3') { ?> 
                                    <p>
                                        Recado arquivado em <?php echo date('d/m/y h:i:s', strTOtime($mural->dataarquivado)); ?>
                                    </p>                                                                                                 
                                <?php } ?>
                            </div> <!--/.description-block -->
        ...
        ?> 
        <div class="col-md-4 ">
            <div class = "alert alert-warning" role = "alert" style = "width: 350px; margin: 20 auto; padding-top: 10px;">
                Vocë náo tem nenhum Recado do Mural arquivado...
            </div>        
        </div>
        <?php
    }
