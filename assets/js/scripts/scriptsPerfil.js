...
$(function () {
    ...
    $('#modal-desbloquear-perfil').on('show.bs.modal', function (event) {
    ...
    $('#modal-bloquear-perfil').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var id = button.data('whatever-id')
        var descricao = button.data('whatever-descricao')        
        var modal = $(this)
    ...
    $('#modal-alterar-perfil').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var id = button.data('whatever-id')
        var descricao = button.data('whatever-descricao')        
        var modal = $(this)
    ...
    $('#modal-excluir-perfil').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget) // Button that triggered the modal
        var id = button.data('whatever-id')
        var descricao = button.data('whatever-descricao')        
        var modal = $(this)
